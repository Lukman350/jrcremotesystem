            ...
            <div class="col-md-4 mx-auto">
              <div class="card">
                    ...
                    <div class="col-md-12 col-lg-12">
                      <form action="#" id="formForgot" method="POST">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control form-login" name="email" id="email" placeholder="Enter Email">
                ...
                <div class="card-action text-center">
                  <button type="button" class="btn btn-secondary btn-block" onclick="forgot()">Reset Password</button>
                  <a href="<?= base_url('login') ?>" class="btn btn-default btn-block">Sign in</a>
                </div>
              </div>
            </div>
          </div>
