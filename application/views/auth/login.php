...
<head>
  ...
  <!-- CSS Libraries -->
  <link rel="stylesheet" href="<?= base_url() ?>vendor/stisla/node_modul/bootstrap-social/bootstrap-social.css">
  ...
  <div id="app">
    <section class="section">
      <div class="d-flex flex-wrap align-items-stretch">
          ...
          <div class="p-4 m-3">
            ...
            <form method="POST" action="#" id="formlogin" class="needs-validation" novalidate="">
              ...
              <div class="form-group text-right">
                ...
                <button type="button" class="btn btn-primary btn-lg btn-icon icon-right" tabindex="4" onclick="login()">
                  Login
                </button>
              </div>
        ...
        <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="<?= base_url() ?>assets/img/unsplash/login-bg-4.jpg">
          <div class="absolute-bottom-left index-2">
            <div class="text-light p-5 pb-2">
              <div class="mb-5 pb-3">
                ...
                <h5 class="font-weight-normal text-muted-transparent" id="time"><?= date('H:i:s') ?></h5>
