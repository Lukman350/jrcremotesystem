...
function ch_sel(id)
{
    ...
    document.getElementById("set_ch").value = document.getElementById("ch" + ch).value;
    document.getElementById("set_freq").value = document.getElementById("freq" + ch).value;
    document.getElementById("set_em").value = document.getElementById("em" + ch).getAttribute("select-idx");
    document.getElementById("set_po").value = document.getElementById("po" + ch).value;
}
...
function http_request(method, url, data)
{
    ...
    {
        http_req.setRequestHeader("If-Modified-Since", "Thu, 01 Jun 1970 00:00:00 GMT");// avoid caching
    }
    http_req.send(data);
}
